...
/**
 * Test the priority controller with multi-active GCM components.
 *
 * @author The ProActive Team
 */
public class TestPriority extends functionalTests.component.requestpriority.Test {
    @Override
    protected Component newFcInstance(GenericFactory gf, ComponentType type,
        ...
        return gf.newFcInstance(type, controllerDescription, new ContentDescription(
            MultiActivePrioritizedComponent.class.getName(), new Object[] {}));
    }
}
